      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="verification">
            <Card>
              <CardHeader>
                <CardTitle>Video Submission Verification</CardTitle>
                    ...
                    <TableBody>
                      {verificationQueue.map(sub => (
                        <TableRow key={sub.id}>
                          ...
                          <TableCell>{new Date(sub.submittedAt?.toDate?.() || sub.submittedAt).toLocaleString()}</TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            <div className="flex gap-2">
                              <Button size="sm" variant="outline" className="text-green-600" onClick={() => {
                                updateDoc(doc(db, 'videoSubmissions', sub.id), { verificationStatus: 'approved', verifiedAt: new Date() });
                                fetchVerificationQueue();
                              }}>
                                <CheckCircle className="h-4 w-4" />
                              </Button>
                              <Button size="sm" variant="outline" className="text-red-600" onClick={() => {
                                updateDoc(doc(db, 'videoSubmissions', sub.id), { verificationStatus: 'rejected', verifiedAt: new Date() });
                                fetchVerificationQueue();
                              }}>
